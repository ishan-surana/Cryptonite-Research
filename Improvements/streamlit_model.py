...
with open('url_hasher.pickle', 'rb') as handle:
...
@st.dialog("Model Summary")
def summary_dialog():
    st.write('Model Summary:')
    model.summary(print_fn=lambda x: st.markdown(x))
...
st.write('This app was created by me. You can find more about me on my [LinkedIn](https://www.linkedin.com/in/your-linkedin-profile).')